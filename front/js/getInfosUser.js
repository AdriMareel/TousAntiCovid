...
// Si vaccin invalide
   ...
   // tabVaccin = ['21/12/2021', "21/06/2022"];
    ...
    if((tabVaccin.length == 0 || tabVaccin.length == 1 || tabVaccin.length == 2 && (date_actuel.getTime() - date_Vaccin.getTime()) / (1000 * 3600 * 24) > 183) && ((typeof date_user === 'undefined') || (date_actuel.getTime() - date_user.getTime()) / (1000 * 3600 * 24) > 183) ){
